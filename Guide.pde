...
void guide2() {
  msg11.lance();
  if(msg11.timerm>1400) {
   msg12.lance(); 
  }
  if(msg11.timerm>2800) {
   msg13.lance(); 
  }
  if(msg11.timerm>4200) {
   msg14.lance(); 
  }
  if(msg11.timerm>5600) {
   msg15.lance(); 
  }
  if(msg11.timerm>7200) {
   msgp5.lance(); 
  }
  if(msg11.timerm>8600) {
   msg16.lance(); 
  }
  if(msg11.timerm>10500) {
    msg11.timerm=-2;
   active=true;
   timearme1=301;
  }
...
void guide3() {
  msg21.lance();
  if(msg21.timerm>1400) {
   msg22.lance(); 
  }
  if(msg21.timerm>3200) {
    msg21.timerm=-2;
   active=true;
   timearme2=501;
  }
...
void guide4() {
  msg31.lance();
  if(msg31.timerm>1400) {
   msg32.lance(); 
  }
  if(msg31.timerm>2800) {
   msg33.lance();
}
if(msg31.timerm>4200) {
   msg34.lance();
}
if(msg31.timerm>5600) {
   msg35.lance();
}
...
void guide5() {
  msg41.lance();
  if(msg41.timerm>1400) {
   msg42.lance(); 
  }
  if(msg41.timerm>2800) {
   msg43.lance();
}
if(msg41.timerm>4200) {
   msg44.lance();
}
if(msg41.timerm>5600) {
   msg45.lance();
}
