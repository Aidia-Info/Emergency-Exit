...
void emote() {
   ...
   if (emote[3]==true && timeemote==300) { timeemote=0;  for(int i=0; i<emote.length ; i++) { emote[i]=false; } active=true; emoteoeil.index=0; key=0;}
...
persoderriere.anim(x-60,y-60,120,120); 
}
