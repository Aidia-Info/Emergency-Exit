...
void cube() {
  fill(150);
if(cubepris==false) { if(salle==sallecube) { image(cubeanim,xc-15,yc-15,30,30); }}
else { image(cubeanim,x-55,y+28,30,30); }


if( touche['e']==true && cubepris==false && x>xc-10 && x <xc+10 && y>yc-10 && y<yc+10 && salle==sallecube && arme==-1) { cubepris=true; cubeson1.close(); cubeson1 = minim.loadSnippet("cubeprit.mp3");  cubeson1.play();}
if(cubepris==false && x>xc-10 && x <xc+10 && y>yc-10 && y<yc+10 && salle==sallecube) { boutone2.anim(xc+10,yc-50,55,55);}

  if(touche['r']==true && cubepris==true) {xc=x; yc=y;  cubepris=false; sallecube=salle; cubeson2.close(); cubeson2 = minim.loadSnippet("cubepose.mp3");  cubeson2.play();}
